...
def test_load_fail():
    ...
    try:
        ...
        CSVDataTable(table_name, connect_info, ['yearID'])
    except Exception as e:
...
def test_find_by_primary_key_fail():
    ...
    try:
        csv_tbl = CSVDataTable(table_name, connect_info, None)
        print("Find by primary key with None key columns")
        csv_tbl.find_by_primary_key(["aardsda01"])
    except Exception as e:
        print("Exception =", e)
        print("Correct answer.")
...
def test_find_by_primary_key_good():
    ...
    try:
        ...
        res = csv_tbl.find_by_primary_key(["aardsda01"])
...
def test_find_by_template_good():
    ...
    try:
        ...
        res = csv_tbl.find_by_template(tmp, ["playerID", "nameFirst", "nameLast", "nameGiven"])
        print("Result =\n", json.dumps(res, indent=2))
        print("Correct answer.")
    except Exception as e:
        print("Exception =", e)
